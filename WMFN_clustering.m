...
clear;clc
%% input paramters
% the directory (fMRI_dir) should contain a directory for each subject,
% an example as follows:
% .../fMRI_dir/subject01/preprocessed_BOLDfMRI.nii;
% .../fMRI_dir/subject02/preprocess_BOLDfMRI.nii;
% ...
...
Result.Dice_coefficient_mean = mean(Result.Dice_coefficient(Cluster_K,:),2);
Result.Dice_coefficient_std = std(Result.Dice_coefficient(Cluster_K,:),1,2);
save([outputfiles_dir,filesep,'CV_similarity.mat'],'Result');
...
figure;errorbar(axis_x, axis_y, axis_errbar); xlabel('Cluster K'); ylabel('Dice coefficient');
saveas(gcf,[outputfiles_dir,filesep,'Clustering_stability.jpg']);
